    ...
    render() {
        return (
            ...
            <View style={styles.otherStyle}>
                ...
                <TouchableOpacity style={styles.opacityStyle} onPress={()=>this.selectConditions(this.state.currentAccountId, this.state.selectedItems)}><Text style={styles.submitStyle}>Save Conditions</Text>
                </TouchableOpacity>
